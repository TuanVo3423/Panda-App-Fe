...
const Study = () => {
  ...
  const tabContent: Record<string, JSX.Element> = {
    ...
    'Giáo viên': (
      <Image
        source={{
          uri: 'https://scontent.fdad3-1.fna.fbcdn.net/v/t39.30808-6/405282475_3104960926302301_3011704467582704741_n.jpg?stp=cp6_dst-jpg&_nc_cat=111&ccb=1-7&_nc_sid=5f2048&_nc_eui2=AeEQla2Uae4YiWreaaazsthET66ZaMVJ8MxPrploxUnwzEjns2mpOx308VtWGBWfI6QkNGGgXQkyI31kiT34TcaM&_nc_ohc=oOc-8NDKJaoAX_81Wtp&_nc_ht=scontent.fdad3-1.fna&oh=00_AfCPbGcASJjg2z_hKdlH3EKla16eIQ3DMEt8DNCENRVJGg&oe=65F9F525',
        }}
        className="w-fit h-[200px] rounded-xl"
      />
    ),
            ...
            <View className="flex-row flex-1 ml-2">
              <View
                style={{
                  ...
                  height: 9,
                  borderRadius: 5,
                  backgroundColor: activeSlide === 0 ? '#fe6505' : 'gray',
                  margin: 5,
                }}
              />
              <View
                style={{
                  ...
                  height: 9,
                  borderRadius: 5,
                  backgroundColor: activeSlide === 1 ? '#fe6505' : 'gray',
                  margin: 5,
                }}
              />
              <View
                style={{
                  ...
                  height: 9,
                  borderRadius: 5,
                  backgroundColor: activeSlide === 2 ? '#fe6505' : 'gray',
                  margin: 5,
                }}
              />
            </View>
    ...
    <View className="mx-5 border-b-[0.5px] border-gray-200 mb-4">
      <View className="flex-row">
        <View className="flex-row items-center pr-2">
          <Text className="font-extrabold text-lg text-red-500">Study</Text>
        </View>
